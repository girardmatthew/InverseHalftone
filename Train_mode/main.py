...
def train(train_list, val_list, debug_mode=True):
    ...
    with tf.name_scope('Loss') as loss_scp:
        ...
        vgg19_api = VGG19("/project/dllau_uksr/mbgi222/InverseHalftoneExp6/Train_mode/vgg19.npy")
...
if __name__ == "__main__":
    ...
    if args.mode == 'train':
        train_list = gen_list('/project/dllau_uksr/mbgi222/InverseHalftoneExp6/Train_mode/input/train/')
        val_list = gen_list('/project/dllau_uksr/mbgi222/InverseHalftoneExp6/Train_mode/input/val/')
